...
try {
	...
	$mpdf->AddPage();
	$mpdf->Image('pagine/2.1.png', 0, 0, 210, 275, 'png', '', true, false);
	$mpdf->AddPage();
	$mpdf->Image('pagine/2.2.png', 0, 0, 210, 275, 'png', '', true, false);
	$mpdf->AddPage();
	$mpdf->Image('pagine/2.3.png', 0, 0, 210, 275, 'png', '', true, false);
	$mpdf->AddPage();
	$mpdf->Image('pagine/2.4.png', 0, 0, 210, 275, 'png', '', true, false);
	$mpdf->AddPage();
	$mpdf->Image('pagine/2.5.png', 0, 0, 210, 275, 'png', '', true, false);
	$mpdf->AddPage();
	$mpdf->Image('pagine/2.6.png', 0, 0, 210, 275, 'png', '', true, false);
	$mpdf->AddPage();
	$mpdf->Image('pagine/2.7.png', 0, 0, 210, 275, 'png', '', true, false);
	$mpdf->AddPage();
	$mpdf->Image('pagine/2.8.png', 0, 0, 210, 275, 'png', '', true, false);
	$mpdf->AddPage();
	$mpdf->Image('pagine/2.9.png', 0, 0, 210, 275, 'png', '', true, false);
	$mpdf->AddPage();
	$mpdf->Image('pagine/2.10.png', 0, 0, 210, 275, 'png', '', true, false);
	$mpdf->AddPage();
